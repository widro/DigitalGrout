...
if( !function_exists ('symple_shortcodes_scripts') ) :
	function symple_shortcodes_scripts() {
		...
		// added v1.1
		wp_register_script('symple_googlemap',  plugin_dir_url( __FILE__ ) . 'js/symple_googlemap.js', array('jquery'), '', true);
		wp_register_script('symple_googlemap_api', 'https://maps.googleapis.com/maps/api/js?sensor=false', array('jquery'), '', true);
	}
