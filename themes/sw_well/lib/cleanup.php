...
function ya_gallery($attr) {
	...
	$output = '<div class="single-gallery">';
	$output .= '<div id="myCarousel'.$post->ID.'" class="carousel slide post-img">';
	...
	foreach ($attachments as $id => $attachment) {
		...
		$output .= '<img src="'.wp_get_attachment_url($id).'" alt="'.$attachment->post_title.'" />';
		$output .= '</div>';
		$i++;
	}
	...
	$output .= '<a class="carousel-control left" href="#myCarousel'.$post->ID.'" data-slide="prev"><i class="icon-circle-arrow-left"></i></a>';
	$output .= '<a class="carousel-control right" href="#myCarousel'.$post->ID.'" data-slide="next"><i class="icon-circle-arrow-right"></i></a>';
	$output .= '</div> </div> </div>';
